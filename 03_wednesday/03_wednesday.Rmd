...
An extension of the Arriaga method decomposing life expectancy by age AND cause of death is also available (see @preston2001demography). There are also generalized decomposition methods that you can use to decompose any function of parameters. Can be demonstrated on request.
